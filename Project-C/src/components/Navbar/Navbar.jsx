...
const DropdownLinks = [
  {
    id: 1,
    name: "Kits Mantención",
    link: "/kit-mantencion",
  },
  {
    id: 2,
    name: "Repuestos Mantención",
        ...
        <div className="container flex justify-between items-center">
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              {/* Iniciar Sesión */}
              <Link to= "/ingresar-cuenta" className="text-sm text-gray-1000 font-semibold flex items-center gap-1 hover:text-primary">
                <FaUser className="text-lg text-gray-600" /> {/* Ícono de usuario */}
                Iniciar Sesión
              </Link>
