...
import Img1 from "../assets/shirt/Suzuki-Filtro-Aceite.jpg";
import Img2 from "../assets/shirt/solenoide-arranque.jpg";
import Img3 from "../assets/shirt/Filtro-Aire.png";
import Img4 from "../assets/shirt/filtro-polen.png"
import Img5 from "../assets/shirt/Filtro-cartucho.jpg"
...
const ProductosData = [
  {
    ...
    img: Img1,
    title: "Filtro Aceite",
    description: "Vehiculo SUZUKI SWIFT 1.2 JPN",
    price: "$17.000",
    aosDelay: "2",
  },
  {
    id: 2,
    img: Img2,
    title: "Solenoide Arranque",
    description: "Vehiculos Hyundai Elantra",
    price: "$29.000",
    aosDelay: "0",
  },
  {
    id: 3,
    img: Img3,
    title: "Filtro Aire CELERIO 1000CC",
    description: "Vehiculo Suzuki",
    price: "$16.900",
    aosDelay: "0",
  },
  {
    id: 4,
    img: Img4,
    title: "Filtro Polen V40",
    description: "Vehiculos Volvo",
    price: "$9.900",
    aosDelay: "0",
  },
  {
    id: 5,
    img: Img5,
    title: "Filtro de Aceite C30/S40 Diesel",
    description: "Vehiculo Diesel",
    price: "$20.900",
    aosDelay: "0",
  },
  ...
  return (
    <div className="mt-24 mb-12">
      <div className="container relative">
        {/* Header */}
        <div className="text-center mb-10 max-w-[600px] mx-auto py-16">
          <p data-aos="fade-up" className="text-4xl font-bold text-primary">
            Repuestos de Mantencion
          </p>
          <p data-aos="fade-up" className="text-2xl font-semibold text-gray-400">
            Aquí encontrarás repuestos a los mejores precios:
          </p>
        </div>
        {/* seccion de filtros */}
